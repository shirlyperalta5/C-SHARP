...
public class DatosdePrueba
{
    ...
    {
        Producto p1 = new Producto(1, "Huawei 8", 5000);
        ListadeProductos.Add(p1);

        Producto p2 = new Producto(2, "Laptop Dell", 21000);
        ListadeProductos.Add(p2);

        Producto p3 = new Producto(3, "pantalla shar 36 pungadas HD", 12000);
        ListadeProductos.Add(p3);

        Producto p4 = new Producto(4, "teclado de escritorio", 505);
        ListadeProductos.Add(p4);

        Producto p5 = new Producto(5, "Mause  Sensor óptico de one", 389);
        ListadeProductos.Add(p5);

        Producto p6 = new Producto(6, "parlante Bluetooth negro", 9000);
        ListadeProductos.Add(p6);
    }

    private void cargarClientes()
    {
        Cliente c1 = new Cliente(1, "TOMAS PASAS", "504.-97574862");
        ListadeClientes.Add(c1);

        Cliente c2 = new Cliente(2, "REVOLVE LOPEZ", "1507-2008-00106");
        ListadeClientes.Add(c2);

        Cliente c3 = new Cliente(3, "LA MUNECA", "0802-1985-01596");
    ...
    private void cargarVendedores()
    {
        ...
        Vendedor v2 = new Vendedor(2, "ROMEO SANTOS", "V0002");
